---
title: 'Introducing icd: comorbidities and code processing for ICD-9 and ICD-10 codes'
author: "Jack O. Wasey"
...
output:
  ...
  pdf_document:
    toc: yes
vignette: >
  %\VignetteIndexEntry{Introducing icd: comorbidities and code processing for ICD-9 and ICD-10 codes}
...
allreal <- icd::icd9cm_hierarchy[["code"]] # or used icd_get_defined
# select the non-V and non-E codes with three characters (zeroes already prefixed)
threedigitreal <- allreal[nchar(allreal) == 3 & icd9_is_n(allreal)]
# display
...
data.frame(icd9 = new_since_27, desc = new_since_27 %>% icd_explain)
# these are a few which were lost since v27
data.frame(icd9 = lost_since_27, desc = lost_since_27 %>% icd_explain)
```
