---
title: 'Introducing icd: comorbidities and code processing for ICD-9 and ICD-10'
author: "Jack O. Wasey"
...
myMap <- icd:::icd9ChaptersToMap(icd9Chapters[c(2, 5, 14)])
...
new_since_27 <- setdiff(icd9cm_billable[["32"]][["icd9"]],
                         icd9cm_billable[["27"]][["icd9"]]) %>% head
lost_since_27 <- setdiff(icd9cm_billable[["27"]][["icd9"]],
                         icd9cm_billable[["32"]][["icd9"]]) %>% tail
