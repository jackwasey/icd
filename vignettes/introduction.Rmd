...
"391" %>%
  children() %>%
  explain_code() # children condensed to parent code
"391" %>%
  children() %>%
  explain_code(condense = FALSE) # prevent condense
```
