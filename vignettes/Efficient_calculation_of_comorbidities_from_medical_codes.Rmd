...

{
  barplot(preds,
          ...
          main = "Predicted time for bigger dataset",
          sub = "One hundred million patients, twenty codes per patient",
          xlab = "hours", log = "y", ylim = c(1, 2500))
  legend(x = 0.2, y = 500, legend = names(preds), fill = colours[names(preds)])
}
