...
plot(x = res$datarows, y = res$comorbidity, log = "xy", 
     type = "l", col = 'darkred', 
     xlab = "log rows of data", 
     ylab = "log seconds",
     xlim = c(1, max(res$datarows)),
     ylim = c(fac, max(res$comorbidity))
) +
  lines(x = res$datarows, y = res$icd, col = 'black') +
  lines(x = res$datarows, y = res$medicalrisk, col = 'darkblue') +
