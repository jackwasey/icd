...
`icd` is carefully optimized to give accurate results as quickly as possible, and [shines](efficiency-prebuilt.html) with huge data sets. For users working with millions of rows of data and higher orders of magnitude, some options can improve throughput.
