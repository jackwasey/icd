...
if (is.null(icd:::get_from_icd_data("icd10who2016", must_work = FALSE))) {
  message("Cannot build this vignette with older version of icd")
  icd_eval = FALSE
}
```
...
```
```{r quicklookeval, echo = FALSE, eval = icd_eval}
