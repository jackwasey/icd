...
icd9Explain("1.0")
icd9Explain("001.1")
icd9Explain(icd9ShortToDecimal("0019"))
...
Quan's paper looked at indices using both ICD-10 and ICD-9-CM. Quan generated updated ICD-9-CM codes for all 30 of Elixhauser and all 17 of Charlson/Deyo's co-morbidities. Thus there are two 'Quan' comorbidity mappings, of which the Charlson/Deyo is provided at present.
<<elix>>=
names(quanCharlsonComorbid)
@
