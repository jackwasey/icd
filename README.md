...
[![CRAN version](http://www.r-pkg.org/badges/version/icd9)](https://cran.r-project.org/package=icd9) [![CRAN RStudio mirror downloads](http://cranlogs.r-pkg.org/badges/icd9)](https://cran.r-project.org/package=icd9) [![Build Status](https://travis-ci.org/jackwasey/icd9.svg?branch=master)](https://travis-ci.org/jackwasey/icd9) [![codecov.io](https://codecov.io/github/jackwasey/icd9/coverage.svg?branch=master)](https://codecov.io/github/jackwasey/icd9?branch=master) [![Coverage Status](https://coveralls.io/repos/github/jackwasey/icd9/badge.svg?branch=master)](https://coveralls.io/github/jackwasey/icd9?branch=master)

###### icd10 development

[![Build Status](https://travis-ci.org/jackwasey/icd9.svg?branch=icd10)](https://travis-ci.org/jackwasey/icd9) [![codecov.io](https://codecov.io/github/jackwasey/icd9/coverage.svg?branch=icd10)](https://codecov.io/github/jackwasey/icd9?branch=icd10) [![Coverage Status](https://coveralls.io/repos/github/jackwasey/icd9/badge.svg?branch=icd10)](https://coveralls.io/github/jackwasey/icd9?branch=icd10)
...
The latest version is available in [github icd9](https://github.com/jackwasey/icd9), which will move to [github icd](https://github.com/jackwasey/icd) in the fututre, and can be installed with:
...
``` r
    ...
    # When the package name changes to 'icd', this will become
    devtools::install_github("jackwasey/icd")
    
    # an alternative to install the current icd10 development branch is to use.
    devtools::install_github("jackwasey/icd9@icd10")
...
A better metric of testing and code quality is code coverage, for which [codecov](https://codecov.io/github/jackwasey/icd9) and [coveralls](https://coveralls.io/github/jackwasey/icd9) are used. The automated [wercker](https://app.wercker.com/#applications/5609d41e71f137d02f0a1069) builds report test coverage results to [codecov](https://codecov.io/github/jackwasey/icd9), whereas the [travis](https://travis-ci.org/jackwasey/icd9) builds report coverage to [coveralls](https://coveralls.io/github/jackwasey/icd9). The parsing code is a significant chunk of code, and may or may not be included in the automated builds depending on whether the source data is available. With the data available, test coverage is &gt;95%. Current coverage for development branch is: [![codecov.io](https://codecov.io/github/jackwasey/icd9/coverage.svg?branch=icd10)](https://codecov.io/github/jackwasey/icd9?branch=icd10) [![Coverage Status](https://coveralls.io/repos/github/jackwasey/icd9/badge.svg?branch=icd10)](https://coveralls.io/github/jackwasey/icd9?branch=icd10)
