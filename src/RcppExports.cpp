...
// icd9ComorbidShort
DataFrame icd9ComorbidShort(DataFrame icd9df, List icd9Mapping, std::string visitId = "visitId", std::string icd9Field = "icd9");
...
BEGIN_RCPP
    SEXP __sexp_result;
    {
        ...
        DataFrame __result = icd9ComorbidShort(icd9df, icd9Mapping, visitId, icd9Field);
