...
test_that("deprecated - can condense the big lists of comorbidities without errors", {
...
test_that("deprecated - ICD-9 codes from SAS source AHRQ exist", {
...
test_that("deprecated - ICD-9 codes from SAS source for Quan Deyo Charlson exist", {
  # Quan Deyo Charlson
...
# ranges
test_that("deprecated - sample of ICD-9 codes from manually specified Quan Elix mapping exist", {
...
test_that("deprecated - sample of ICD-9 codes from manually specified Elixhauser mapping exist", {
...
test_that("deprecated - github #34 - short and long custom map give different results", {
...
test_that("deprecated - no NA values in the co-morbidity lists", {
...
test_that("deprecated - built-in icd9 to comorbidity mappings are all valid", {
...
test_that("deprecated - disordered visit ids", {
...
test_that("deprecated - comorbid quick test", {
...
test_that("deprecated - failing example", {
...
test_that("deprecated - disordered visitIds works by default", {
  set.seed(1441)
...
test_that("deprecated - comorbidities created from source data frame coded as factors", {
