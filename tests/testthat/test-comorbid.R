...
test_that("ICD-9 codes from SAS source AHRQ exist", {
  ...
  expect_true("39720" %in% ahrqComorbid$Valvular)
  # SAS: "7463 "-"7466 "
...
#   "5064 "         = "CHRNLUNG"  /* Chronic pulmonary disease */
  ...
  expect_true("49299" %in% ahrqComorbid$Pulmonary)
  ...
  expect_true("49399" %in% ahrqComorbid$Pulmonary)
  expect_true("49300" %in% ahrqComorbid$Pulmonary)
  expect_true("49392" %in% ahrqComorbid$Pulmonary)
  expect_true("49329" %in% ahrqComorbid$Pulmonary) # implied intermediate
...
#   "64830"-"64834" = "DRUG"      /* Drug abuse */
  ...
  expect_true("30499" %in% ahrqComorbid$Drugs)
  expect_true("" %in% ahrqComorbid$Drugs)
  ...
  expect_true("30529" %in% ahrqComorbid$Drugs)
  expect_false("3059" %in% ahrqComorbid$Drugs)
  expect_false("30593" %in% ahrqComorbid$Drugs)
  expect_false("30599" %in% ahrqComorbid$Drugs)
