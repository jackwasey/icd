...
test_that("expand icd9 range definition", {
  expect_equal_no_icd(
    expand_range(
      short_code = TRUE, "4012", "40145",
      defined = FALSE,
      ex_ambig_start = FALSE,
      ex_ambig_end = FALSE
    ),
    sort(c(
      "4012", "40120", "40121", "40122", "40123", "40124", "40125",
  ...
  expect_equal_no_icd(
    expand_range("40108", "40109", short_code = TRUE, defined = FALSE),
    c("40108", "40109")
  )
  expect_equal_no_icd(
  ...
  expect_equal_no_icd(
    ...
    sort(c("4410", expand_range(
      short_code = TRUE, "44100", "4412",
      defined = FALSE
    )))
  )
  ...
  expect_equal(
    ...
    sort(children("401", short_code = TRUE, defined = FALSE))
  )
  ...
  expect_equal(
    ...
    sort(children(c("401", "402"), short_code = TRUE, defined = FALSE))
  )
  ...
  expect_equal(
    expand_range(
      short_code = TRUE, "043", "0449", defined = FALSE,
      ex_ambig_end = FALSE
    ),
    expand_range(short_code = TRUE, "043", "044", defined = FALSE)
  )
  expect_equal(
    expand_range(short_code = TRUE, "043", "04499", defined = FALSE),
    expand_range(short_code = TRUE, "043", "044", defined = FALSE)
  )
  expect_equal_no_icd(
    expand_range(short_code = TRUE, "401", "402", defined = FALSE),
  ...
  expect_equal_no_icd(
    expand_range(
      short_code = TRUE, "401", "40102", defined = FALSE,
      ex_ambig_start = FALSE,
      ex_ambig_end = FALSE
    ),
...
test_that("range of two four digit codes has last code", {
  expect_true(
    "1991" %in% expand_range(
      short_code = TRUE, "1960", "1991",
      defined = FALSE
    )
  )
  expect_true(
    "19919" %in% expand_range(
      short_code = TRUE, "1960", "1991",
      defined = FALSE
    )
  )
...
test_that("V code with ambiguous parent", {
  ...
  expect_equal_no_icd(
    expand_range(short_code = TRUE, "V10", "V1001", defined = FALSE),
    c("V1000", "V1001")
  )
})
...
test_that("V code ranges", {
  expect_equal_no_icd(
    expand_range(short_code = TRUE, "V1000", "V1002", defined = FALSE),
    c("V1000", "V1001", "V1002")
  )
  # but we cap off the upper range correctly:
  expect_equal_no_icd(
    expand_range(short_code = TRUE, "V1009", "V101", defined = FALSE),
    c(
      "V1009", "V101", "V1010", "V1011",
  ...
  expect_true(
    all(c("V10", "V100") %in% expand_range("V099", "V1011",
      short_code = TRUE,
      defined = FALSE,
      ex_ambig_start = FALSE,
      ex_ambig_end = FALSE
  ...
  expect_identical(
    expand_range(short_code = TRUE, "V1009", "V101", defined = FALSE),
    expand_range(short_code = TRUE, "V1009", "V1019", defined = FALSE)
  )

  # failed similar test in Elixhauser mapping generation.
  expect_false("V11" %in% expand_range("V10.89", "V10.9",
    short_code = FALSE,
    defined = FALSE
  ))
  expect_false("V11" %in% expand_range("V10.89", "V10.99",
    short_code = FALSE,
    defined = FALSE
  ))
})
...
test_that("E code ranges", {
  expect_equal_no_icd(
    expand_range(short_code = TRUE, "E9501", "E9502", defined = FALSE),
    c("E9501", "E9502")
  )
  expect_equal_no_icd(
    expand_range(short_code = TRUE, "E950", "E9509", defined = FALSE),
    c(
...
test_that("major ranges", {
  resall <- expand_range_major(as.icd9("E000"), "E999", defined = FALSE)
  expect_equal(length(resall), 1000)
  expect_true("E000" %in% resall)
  expect_true("E123" %in% resall)
  expect_true("E999" %in% resall)
  resallbut <- expand_range_major(as.icd9("E001"), "E998", defined = FALSE)
  expect_equal(length(resallbut), 998)

  expect_identical(
    "111" %i9mj% "789",
    expand_range_major("111", "789", defined = TRUE)
  )

  expect_identical(
    "V01" %i9mj% "V99",
    expand_range_major(as.icd9("V01"), "V99", defined = TRUE)
  )

  expect_identical(
    "E001" %i9mj% "E998",
    expand_range_major(as.icd9("E001"), "E998", defined = TRUE)
  )
  ...
  expect_equal_no_icd(
    expand_range_major(as.icd9("E99"), "E101", defined = FALSE),
    c("E099", "E100", "E101")
  )
})
...
test_that("expand_minor.icd9: invalid", {
  ...
  expect_error(
    expand_minor.icd9("999", is_e = FALSE),
...
test_that("expand_minor.icd9: valid", {
  ...
  expect_identical(
    expand_minor.icd9("9", is_e = FALSE),
...
test_that("icd9 children decimal with valid input", {
  expect_equal_no_icd(
    children(short_code = FALSE, "V10.0", defined = FALSE),
    append("V10.0", paste("V10.0", 0:9, sep = ""))
  )
  expect_equal(
    toupper(children(short_code = FALSE, "v10.0", defined = FALSE)),
    children(short_code = FALSE, "V10.0", defined = FALSE)
  )
  expect_equal(
    children(short_code = FALSE, "10.0", defined = FALSE),
    children(short_code = FALSE, "010.0", defined = FALSE)
  )
  expect_equal_no_icd(
    children(short_code = FALSE, "010.0", defined = FALSE),
  ...
  expect_equal(
    children(short_code = FALSE, "010.0"),
    children(short_code = FALSE, "10.0")
  )
})

test_that("icd9 children short with valid input", {
  expect_equal_no_icd(
    children(short_code = TRUE, "V100", defined = FALSE),
    paste("V100", c("", 0:9), sep = "")
  )
  expect_equal(
    children(short_code = TRUE, "v100"),
    children("V100")
  )
  expect_equal_no_icd(
    children(short_code = TRUE, "0100", defined = FALSE),
    paste("0100", c("", 0:9), sep = "")
  )
  expect_equal_no_icd(
    children(short_code = TRUE, "1", defined = FALSE)[1], "001"
  )
  expect_equal_no_icd(
    children(short_code = TRUE, "01", defined = FALSE)[1], "001"
  )
  expect_equal_no_icd(
    children(short_code = TRUE, "001", defined = FALSE)[1], "001"
  )
  expect_equal_no_icd(
    children(short_code = TRUE, "023", defined = FALSE)[1], "023"
  )
  expect_equal_no_icd(
    children(short_code = TRUE, "23", defined = FALSE)[1], "023"
  )
  expect_equal_no_icd(
    children(short_code = TRUE, "456", defined = FALSE)[1], "456"
  )
  expect_equal_no_icd(
    children(short_code = TRUE, "E100", defined = FALSE),
    c(
      "E100", "E1000", "E1001", "E1002", "E1003", "E1004",
      "E1005", "E1006", "E1007", "E1008", "E1009"
    )
  )
  expect_equal_no_icd(
    children(short_code = TRUE, "390", defined = TRUE), "390"
  )
})
...
test_that("sorting char vectors", {
  expect_equal(
    icd:::sort.icd9(short_code = TRUE, c("003", "002", "001", "003")),
    c("001", "002", "003", "003")
  )
  expect_equal(
    sort_icd(short_code = TRUE, c("003", "002", "001", "003")),
    c("001", "002", "003", "003")
  )
  expect_equal(
    icd:::sort.icd9(c("001", "V02", "V01", "E003"),
      short_code = TRUE
    ),
    c("001", "V01", "V02", "E003")
  )
  expect_equal(
    icd:::sort.icd9(
      c("0032", "0288", "0019", "0031"),
      short_code = TRUE
    ),
    c("0019", "0031", "0032", "0288")
  )
  expect_equal(
    icd:::sort.icd9(c("V251", "V25", "E0039", "E003"),
      short_code = TRUE
    ),
    c("V25", "V251", "E003", "E0039")
  )
  expect_equal(
    icd:::sort.icd9(c("V25.1", "V25", "E003.9", "E003"),
      short_code = FALSE
    ),
...
test_that("sorting char factors", {
  ...
  expect_equal(
    icd:::sort.icd9(factor(c("001", "V02", "V01", "E003")),
      short_code = TRUE
    ),
  ...
  expect_equal(
    icd:::sort.icd9(factor(c("V251", "V25", "E0039", "E003")),
      short_code = TRUE
    ),
    factor(c("V25", "V251", "E003", "E0039"))
  )
  expect_equal(
    icd:::sort.icd9(factor(c("V25.1", "V25", "E003.9", "E003")),
      short_code = FALSE
    ),
...
test_that("expand ICD-9 range character class deals with short vs long types", {
  expect_true(all(is_valid.icd9(
    res_a <- expand_range("410", "410.8"),
    short_code = FALSE
  )))
  expect_true(all(is_valid.icd9(
    res_b <- expand_range("410", "4108"),
    short_code = TRUE
  )))
...
test_that("chapter major expansion works for basic test", {
  expect_equal(
    ...
    icd9(c(
      "E916", "E917", "E918", "E919", "E920", "E921", "E922",
...
test_that("subrange matches wider range", {
  expect_equivalent(
    ...
    icd9(c(
      "550", "5500", "55000", "55001", "55002", "55003",
      "5501", "55010", "55011", "55012", "55013",
