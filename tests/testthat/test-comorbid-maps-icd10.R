...
test_that("independently created list of Quan Elixhauser codes all appear", {
  ...
  quan_elix_independent <- list(
    ...
    valvular = c(
      "A520", "I05", "I06", "I07", "I08", "I091", "I098", "I34",
      "I35",
