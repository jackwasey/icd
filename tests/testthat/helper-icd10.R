...
icd10_all_elix <- data.frame(pt_id = 1:31, icd10_code = icd10_each_cmb, stringsAsFactors = FALSE) %>% icd10cm

icd10_all_elix_one_pt <- data.frame(pt_id = rep(1, 31), icd10_code = icd10_each_cmb)
