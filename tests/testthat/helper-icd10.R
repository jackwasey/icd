...
icd10_all_ahrq <- data.frame(pt_id = 1:31, icd10_code = icd10_each_ahrq_cmb, stringsAsFactors = FALSE) %>% icd10cm
icd10_all_ahrq_one_pt <- data.frame(pt_id = rep(1, 31), icd10_code = icd10_each_ahrq_cmb)
