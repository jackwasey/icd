...
test_that("condense big lists of comorbidities", {
  ...
  # reverse)
  expect_error(ahrq <- lapply(icd9_map_ahrq[c(1, 30)], icd_condense.icd9, short_code = TRUE, defined = FALSE), regexp = NA)
  expect_error(qd <- lapply(icd9_map_quan_deyo[c(1, 17)], icd_condense.icd9, short_code = TRUE, defined = FALSE), regexp = NA)
  expect_error(qe <- lapply(icd9_map_quan_elix[c(1, 30)], icd_condense.icd9, short_code = TRUE, defined = FALSE), regexp = NA)
  expect_error(elix <- lapply(icd9_map_elix[c(1, 30)], icd_condense.icd9, short_code = TRUE, defined = FALSE), regexp = NA)
