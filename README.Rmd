...
```{r tableone, fig.cap="NHDS 2010 comorbidities to demonstrate Table One creation. Presented as counts (percentage prevalence in group)"}
...
Look at the help files for details and examples of almost every function in this package. There are several vignettes showing the main features:
 ...
 - [Paper detailing efficient matrix method of comorbidities](efficiency.html)
