...
generate_sysdata <- function(save_data = TRUE) {
  ...
  icd9NShortReal <- grep("^[^VE]+", icd9::icd9cm_hierarchy[["code"]], value = TRUE) # nolint
  icd9VShortReal <- grep("V", icd9::icd9cm_hierarchy[["code"]], value = TRUE) # nolint
  icd9EShortReal <- grep("E", icd9::icd9cm_hierarchy[["code"]], value = TRUE) # nolint
