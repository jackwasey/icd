...
icd9_generate_map_pccc_dx <- function(save_data = TRUE) {
  icd9_map_pccc_orig_dx <- list(
    ...
    hemato_immu = c("042","043","044","135","279","2820","2821","2822","2823","2824","2825",
                    "2826","2881","2882","284","2860","2863","28732","28733","28739","28801","28802",
                    "2884","4460","4461","44621","4464","4465","4466","4467","7100","7101","7103","V08"),
    metabolic = c("243","2532","2535","2536","2539","2550","25513","2552","270","271","272",
                  "2750","2751","2752","2753","2772","2773","2774","2775","2776","2778","2779",
                  "V4585","V5391","V6546"),
    congeni_genetic = c("2594","5533","7373","7560","7561","7562","7563","7564","7565","7566",
                        "7567","758","7597","7598","7599"),
    malignancy = c(expand.grid(c("14","15","16","17","18","19","20","23"), 0:9) %>% apply(1, paste, collapse = ""),
                   "V4281", "V4282"),
    neonatal = c("76401","76402","76411","76412","76421","76422","76491","76492","76501",
                 ...
                 "7797"),
    tech_dep = c("5190","5364","9960","9961","9962","9964","99661","99662","99663","99666","99667",
    ...
    transplant = c("99680","99681","99682","99683","99684","99685","99686","99687","99688","99689",
...
icd10_generate_map_pccc_pc <- function(save_data = TRUE) {
  ...
  if (save_data) {
    ...
    save_in_data_dir(icd10_map_pccc_orig_pc)
  }
