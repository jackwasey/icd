...
icd9_generate_map_pccc_dx <- function(save_data = TRUE) {
  icd9_map_pccc_orig_dx <- list(
    neuromusc = c("3180", "3181", "3182", "330", "331", "3320", "3321",
                  ...
                  "V5301", "V5302"),
    cvd = c("4161", "4168", "4169", "4240", "4258", "4242", "4243", "4250",
            "4251", "4252", "4253",
    ...
    neonatal = c("76401", "76402", "76411", "76412", "76421", "76422", "76491",
                 ...
                 "7797"),
    tech_dep = c("5190", "5364", "9960", "9961", "9962", "9964", "99661",
                 ...
                 "V555", "V556"),
    transplant = c("99680", "99681", "99682", "99683", "99684", "99685",
...
icd9_generate_map_pccc_pcs <- function(save_data = TRUE) {
  icd9_map_pccc_orig_pc <- list(
    ...
    cvd = c("0050", "0051", "0053", "0054", "0055", "0057", "1751", "1752", "3581", "3582", "3583",
    ...
    respiratory = c("303", "304", "3121", "3129", "3141", "3174", "3241", "3249", "3250", "3259", "3321",
                    "3350", "3351", "3352", "336", "3485", "9655", "9723"),
    renal = c("3895", "3927", "3942", "3993", "3994", "3995", "5498", "5502", "5503", "5504", "5512",
    ...
    gi = c("253", "254", "4210", "4211", "4242", "4281", "4311", "4319", "4391", "4399", "4412",
           ...
           "5471", "9624", "9636", "9702"),
    hemato_immu = c("4100", "4101", "4102", "4103", "4104", "4105", "4106", "4107", "4108", "4109", "415",
                    "4194"),
    ...
    tech_dep = c("0221", "0222", "0231", "0232", "0233", "0234", "0235", "0239", "0241", "0242", "0293", "0371",
                 ...
                 "8451"),
    transplant = c("3751", "3350", "3351", "3352", "336", "5561", "5569", "4697", "5051", "5059", "5280", "5282",
...
icd10_generate_map_pccc_dx <- function(save_data) {
  icd10_map_pccc_orig_dx <- list(
    neuromusc = c("E75", "F71", "F72", "F73", "F842", "G111", "G112", "G114", "G118",
    ...
    hemato_immu = c("B20", "D55", "D56", "D57", "D58", "D60", "D61", "D71", "D720", "D80", "D81", "D82",
    ...
    metabolic = c("E700", "E702", "E703", "E704", "E705", "E708", "E710", "E711", "E712", "E713",
    ...
    congeni_genetic = c("E343", "K449", "M410", "M412", "M4130", "M418", "M419", "M4330", "M965", "Q722", "Q750",
    ...
    malignancy = c("C", "D00", "D01", "D02", "D03", "D04", "D05", "D06", "D07", "D08", "D09", "D37", "D38",
                   "D39", "D3A0", "D40", "D41", "D42", "D43", "D44", "D45", "D46", "D47", "D48", "D49", "Q850", "Z9481",
                   "Z9484", "T8600", "T8601", "T8602", "T8609"),
    neonatal = c("P0501", "P0511", "P0502", "P0512", "P052", "P059", "P0701", "P0702", "P0721", "P0722",
    ...
    tech_dep = c("T8509XA", "T85190A", "T85192A", "T85199A", "T8579XA", "Z982", "Z45441", "Z45442", "T82519A",
    ...
    transplant = c("T8600", "T8601", "T8602", "T8609", "T8610", "T8611", "T8612", "T8620", "T8621", "T8622",
...
icd10_generate_map_pccc_pcs <- function(save_data = TRUE) {
  icd10_map_pccc_orig_pc <- list(
    ...
    cvd = c("02170ZP", "02170ZQ", "02170ZR", "02BK0ZZ", "02H40JZ", "02H40KZ", "02H43JZ", "02H44JZ",
    ...
    respiratory = c("0B110F4", "0B110Z4", "0B113F4", "0B113Z4", "0B114F4", "0B114Z4", "0B21XFZ", "0BHR0MZ",
    ...
    renal = c("031209D", "031209F", "03120AD", "03120AF", "03120JD", "03120JF", "03120KD", "03120KF",
    ...
    gi = c("0CT70ZZ", "0CT7XZZ", "0D11074", "0D110J4", "0D110K4", "0D110Z4", "0D113J4", "0D11474",
    ...
    hemato_immu = c("07TP0ZZ", "07TP4ZZ", "07YP0Z0", "07YP0Z1", "07YP0Z2", "30230AZ", "30230G0", "30230G1",
    ...
    metabolic = c("0GT00ZZ", "0GT04ZZ", "0GT40ZZ", "0GT44ZZ", "0GTK0ZZ", "0GTK4ZZ", "0GTR0ZZ", "0GTR4ZZ",
    ...
    malignancy = c("3E00X05", "3E01305", "3E02305", "3E03005", "3E03305", "3E04005", "3E04305", "3E05005",
                   ...
                   "3E0Y705"),
    tech_dep = c("00160J0", "00160J1", "00160J2", "00160J4", "00160J5", "00160J6", "00160J7", "00160J8",
    ...
    transplant = c("02YA0Z0", "02YA0Z1", "02YA0Z2", "0BYC0Z0", "0BYC0Z1", "0BYC0Z2", "0BYD0Z0", "0BYD0Z1",
