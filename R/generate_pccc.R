...
icd9_generate_map_pccc_pcs <- function(save_data = TRUE) {
  icd9_map_pccc_orig_pc <- list(
    ...
    hemato_immu = c(
      ...
      "4194"),
    metabolic = c(
      "064", "0652", "0681", "073", "0764", "0765", "0768", "0769", "6241", "645", "6551",
...
icd10_generate_map_pccc_dx <- function(save_data) {
  icd10_map_pccc_orig_dx <- list(
    ...
    cvd = c(
      ...
      "Q256", "Q257", "Q258", "Q259", "Q26", "Q268", "R001", "Q282", "Q283", "Q289",
    ...
    respiratory = c(
      "E84", "G4735", "I2782", "Q30", "Q31", "Q32", "Q33", "Q34", "P280", "Z902", "J84112",
    ...
    metabolic = c(
      "E700", "E702", "E703", "E704", "E705", "E708", "E710", "E711", "E712", "E713",
