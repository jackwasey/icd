...
generateSysData <- function(sysdata.path = file.path("R", "sysdata.rda"), save = TRUE) {
  ...
  icd9NShortBillable <- icd9cm_get_billable.short_code(icd9NShortReal, version = "32") # nolint
  icd9VShortBillable <- icd9cm_get_billable.short_code(icd9VShortReal, version = "32") # nolint
  icd9EShortBillable <- icd9cm_get_billable.short_code(icd9EShortReal, version = "32") # nolint
