...
#' contrast, \code{\link{icd_is_defined}} checks whether ICD-9 codes correspond
#' to diagnoses in the current ICD-9-CM definition from CMS.}
#'
...
#' \code{\link{icd9Children}} and find a common parent to a set of children (or
#' arbitrary list of ICD-9 codes) with \code{\link{icd9Condense}}.
#' \code{\link{icd9Sort}} sorts in hierarchical, then numerical order, so 100.0
#' comes before 100.00, for example. \code{\link{icd_wide_to_long}} and
...
#' list of codes into human-readable descriptions. This function can optionally
#' reduce the codes to a their top-level groups if all the child members of a
#' group are present. \code{\link{icd9DiffComorbid}} allows summary of the
#' differences between comorbidity mappings, e.g. to find what has changed from
#' year-to-year or between revisions by different authors.
#' \code{\link{icd9_hierarchy}} is a \code{data.frame} containing the full ICD-9
#' classification for each diagnosis. \code{\link{icd9Chapters}} contains
#' definitions of chapters, sub-chapters and three-digit groups.}
#'
#' }
#'
#' @docType package
