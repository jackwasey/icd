...
#' @export
icd9Explain <- function(icd9, isShort) UseMethod("icd9Explain")

#' @rdname icd9Explain
#' @export
icd9ExplainShort <- function(icd9Short) icd9Explain(icd9Short, isShort = TRUE)

#' @rdname icd9Explain
#' @export
icd9ExplainDecimal <- function(icd9Decimal) icd9Explain(icd9Decimal, isShort = FALSE)

#' @describeIn icd9Explain explain alll ICD-9 codes in a list of vectors
#' @export
icd9Explain.list <- function(icd9, isShort) lapply(icd9, icd9Explain, isShort = isShort)

#' @describeIn icd9Explain explain character vector of ICD-9 codes
#' @export
icd9Explain.character <- function(icd9, isShort) {
...
#' @export
icd9Explain.numeric <- function(icd9, isShort) {
