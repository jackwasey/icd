...
setDecimalCodeInPlace <- function(x) {
    invisible(.Call('icd_setDecimalCodeInPlace', PACKAGE = 'icd', x))
}

setDecimalCode <- function(x) {
    .Call('icd_setDecimalCode', PACKAGE = 'icd', x)
}

icd_set_short_code <- function(x) {
    invisible(.Call('icd_setShortCode', PACKAGE = 'icd', x))
}
