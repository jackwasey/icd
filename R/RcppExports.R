...
#' @rdname convert
#' @keywords internal manip
icd9ShortToPartsCppStd <- function(icd9Short, minorEmpty, major, minor) {
    invisible(.Call('icd_icd9ShortToPartsCppStd', PACKAGE = 'icd', icd9Short, minorEmpty, major, minor))
}
...
#' }
#' @keywords internal
icd9ChildrenShortCpp11 <- function(icd9Short, onlyReal) {
    .Call('icd_icd9ChildrenShortCpp11', PACKAGE = 'icd', icd9Short, onlyReal)
}

icd9ExpandMinorShim <- function(minor, isE) {
