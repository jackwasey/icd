...
icd9Comorbid_cpp <- function(icd9df, icd9Mapping, visitId = "visitId", icd9Field = "icd9") {
    .Call('icd9_icd9Comorbid_cpp', PACKAGE = 'icd9', icd9df, icd9Mapping, visitId, icd9Field)
}
