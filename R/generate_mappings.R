...
icd10_generate_map_elix <- function(save_data = TRUE) {
  icd10_map_elix <- list(
    ...
    arrhythmia = c("I441", "I442", "I443", "I456", "I459", "I47", "I48", "I49",
                   "R000", "R001",
                   "R008", "T821", "Z450", "Z950"),
    valve = c("A520", "I05", "I06", "I07", "I08", "I091", "I098", "I34", "I35",
              "I36", "I37", "I38",
    ...
    paralysis = c("G041", "G114", "G801", "G802", "G81", "G82", "G830", "G831",
                  "G832", "G833",
                  "G834", "G839"),
    neuro.other = c("G10", "G11", "G12", "G13", "G20", "G21", "G22", "G254",
                    "G255", "G312", "G318",
                    "G319", "G32", "G35", "G36", "G37", "G40", "G41", "G931",
                    "G934", "R470", "R56"),
    chronic.pulm = c("I278", "I279", "J40", "J41", "J42", "J43", "J44", "J45",
                     "J46", "J47", "J60",
                     "J61", "J62", "J63", "J64", "J65", "J66", "J67", "J684",
                     "J701", "J703"),
    dm.uncomp = c("E100", "E101", "E109", "E110", "E111", "E119", "E120",
                  "E121", "E129", "E130",
                  "E131", "E139", "E140", "E141", "E149"),
    dm.comp = c("E102", "E103", "E104", "E105", "E106", "E107", "E108", "E112",
                "E113", "E114",
    ...
    renal = c("I120", "I131", "N18", "N19", "N250", "Z490", "Z491", "Z492",
              "Z940", "Z992"),
    liver = c("B18", "I85", "I864", "I982", "K70", "K711", "K713", "K714",
              "K715", "K717", "K72",
    ...
    lymphoma = c("C81", "C82", "C83", "C84", "C85", "C88", "C96", "C900",
                 "C902"),
    mets = c("C77", "C78", "C79", "C80"),
    solid.tumor = c("C00", "C01", "C02", "C03", "C04", "C05", "C06", "C07",
                    "C08", "C09", "C10",
                    ...
                    "C71", "C72", "C73",
                    "C74", "C75", "C76", "C97"),
    rheum = c("L940", "L941", "L943", "M05", "M06", "M08", "M120", "M123",
              "M30", "M310", "M311",
    ...
    etoh = c("F10", "E52", "G621", "I426", "K292", "K700", "K703", "K709",
             "T51", "Z502", "Z714",
             "Z721"),
    drugs = c("F11", "F12", "F13", "F14", "F15", "F16", "F18", "F19", "Z715",
              "Z722"),
    psychoses = c("F20", "F22", "F23", "F24", "F25", "F28", "F29", "F302",
                  "F312", "F315"),
    depression = c("F204", "F313", "F314", "F315", "F32", "F33", "F341",
                   "F412", "F432")
  )
...
icd9_generate_map_quan_elix <- function(save_data = TRUE) {
  icd9_map_quan_elix <- list(
    ...
    valve = c("93.2", "394" %i9da% "397", "424", "746.3" %i9da% "746.6",
              "V42.2", "V43.3"),
...
icd10_generate_map_quan_elix <- function(save_data = TRUE) {
  quan_elix_raw <- list(
    ...
    c("I441", "I442", "I443", "I456", "I459", "I47", "I48", "I49", "R000",
      "R001", "R008", "T821", "Z450", "Z950"),
    c("A520", "I05", "I06", "I07", "I08", "I091", "I098", "I34", "I35", "I36",
      "I37", "I38", "I39", "Q230", "Q231",
      "Q232", "Q233", "Z952", "Z953", "Z954"),
    c("I26", "I27", "I280", "I288", "I289"),
    c("I70", "I71", "I731", "I738", "I739", "I771", "I790", "I792", "K551",
      "K558", "K559", "Z958", "Z959"),
    c("I10"),
    c("I11", "I12", "I13", "I15"),
    c("G041", "G114", "G801", "G802", "G81", "G82", "G830", "G831", "G832",
      "G833", "G834", "G839"),
    c("G10", "G11", "G12", "G13", "G20", "G21", "G22", "G254", "G255", "G312",
    ...
    c("E100", "E101", "E109", "E110", "E111", "E119", "E120", "E121", "E129",
      "E130", "E131", "E139", "E140", "E141",
      "E149"),
    c("E102", "E103", "E104", "E105", "E106", "E107", "E108", "E112", "E113",
    ...
    c("I120", "I131", "N18", "N19", "N250", "Z490", "Z491", "Z492", "Z940",
      "Z992"),
    c("B18", "I85", "I864", "I982", "K70", "K711", "K713", "K714", "K715",
    ...
    c("C00", "C01", "C02", "C03", "C04", "C05", "C06", "C07", "C08", "C09",
      ...
      "C74", "C75", "C76", "C97"),
    c("L940", "L941", "L943", "M05", "M06", "M08", "M120", "M123", "M30",
    ...
    c("F10", "E52", "G621", "I426", "K292", "K700",
      "K703", "K709", "T51", "Z502", "Z714", "Z721"),
    drugs = c("F11", "F12", "F13", "F14", "F15", "F16",
              "F18", "F19", "Z715", "Z722"),
...
icd10_generate_map_quan_deyo <- function(save_data = TRUE) {
  quan_charl_raw <- list(
    ...
    cvd = c("G45", "G46", "I60", "I61", "I62", "I63", "I64", "I65", "I66",
            "I67", "I68", "I69", "H340"),
    ...
    cancer = c("C00", "C01", "C02", "C03", "C04", "C05", "C06", "C07",
