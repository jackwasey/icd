...
#' @param validate Single logical value, if `TRUE`, the input factor is checked
...
#'   code. The default is `FALSE`. For huge data sets, and known valid input,
#'   skipping this check saves significant time. `icd::factor_is_valid` can be
#'   used independently.
#' @examples
#' \dontrun{
#' f <- factor(c(1, 2, 3))
